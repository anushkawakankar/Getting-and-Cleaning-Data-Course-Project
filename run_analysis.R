...
dataset.tidy <- cast(dataset.melt, activitylabel + subject ~ variable, mean)
#print(cast(dataset.melt, activitylabel + subject ~ variable, mean))
#creating a tidy dataset file  
write.table(dataset.tidy, file = "cleandataset.txt", row.names = FALSE)
