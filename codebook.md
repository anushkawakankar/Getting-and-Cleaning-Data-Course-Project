...
The following data transformations were conducted to form a clean dataset:  
...
2. Clean dataset was build as a mean values of features grouped by ***activitylabel*** and ***subject*** - for each subject and activity type determined mean values over all activities of that type.  
